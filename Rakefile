...
task all_rpms: :build do
  ...
  puts '      rubygem-netaddr-chef-1.5.1-3.eos4.noarch.rpm \\'
  puts '      rubygem-net_http_unix-chef-0.2.1-5.eos4.noarch.rpm'
  puts '    Puppet Open Source: '
  puts '      cd /mnt/flash; \\'
  puts "      swix create rbeapi-#{Rbeapi::VERSION}-2.swix \\"
  puts "      rubygem-rbeapi-#{Rbeapi::VERSION}-2.eos4.noarch.rpm \\"
  ...
  puts '      cd/mnt/flash; \\'
  puts "      swix create rbeapi-puppet3-#{Rbeapi::VERSION}-2.swix \\"
  puts "      rubygem-rbeapi-puppet3-#{Rbeapi::VERSION}-2.eos4.noarch.rpm \\"
  ...
  puts '      cd/mnt/flash; \\'
  puts "      swix create rbeapi-puppet-aio-#{Rbeapi::VERSION}-2.swix \\"
  puts "      rubygem-rbeapi-puppet-aio-#{Rbeapi::VERSION}-2.eos4.noarch.rpm \\"
  puts '      rubygem-inifile-puppet-aio-3.0.0-5.eos4.noarch.rpm \\'
  puts '      rubygem-netaddr-puppet-aio-1.5.1-3.eos4.noarch.rpm \\'
  puts '      rubygem-net_http_unix-puppet-aio-0.2.1-5.eos4.noarch.rpm'
end
...
task swix: :all_rpms do
  ...
  system "(cd rpms/noarch;
          rm -f rbeapi-chef-#{Rbeapi::VERSION}-2.swix;
          #{SWIX} create rbeapi-chef-#{Rbeapi::VERSION}-2.swix \
          rubygem-rbeapi-chef-#{Rbeapi::VERSION}-1.eos4.noarch.rpm \
          rubygem-inifile-chef-3.0.0-5.eos4.noarch.rpm \
          rubygem-netaddr-chef-1.5.1-3.eos4.noarch.rpm \
          rubygem-net_http_unix-chef-0.2.1-5.eos4.noarch.rpm)"
  system "(cd rpms/noarch;
          rm -f rbeapi-#{Rbeapi::VERSION}-2.swix;
          #{SWIX} create rbeapi-#{Rbeapi::VERSION}-2.swix \
          ...
          rubygem-net_http_unix-0.2.1-5.eos4.noarch.rpm)"
  system "(cd rpms/noarch;
          rm -f rbeapi-puppet3-#{Rbeapi::VERSION}-2.swix;
          #{SWIX} create rbeapi-puppet3-#{Rbeapi::VERSION}-2.swix \
  ...
  system "(cd rpms/noarch;
          ...
          #{SWIX} create rbeapi-puppet-aio-#{Rbeapi::VERSION}-2.swix \
          rubygem-rbeapi-puppet-aio-#{Rbeapi::VERSION}-2.eos4.noarch.rpm \
          rubygem-inifile-puppet-aio-3.0.0-5.eos4.noarch.rpm \
          rubygem-netaddr-puppet-aio-1.5.1-3.eos4.noarch.rpm \
          rubygem-net_http_unix-puppet-aio-0.2.1-5.eos4.noarch.rpm)"
